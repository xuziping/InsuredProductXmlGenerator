package com.xuzp.insuredxmltool.core.insurance.product.rule;
...
public class Rule implements Serializable
{
	...
	public final static int TYPE_CUSTOMER		= 1;				//客户级别的规则
	public final static int TYPE_PRODUCT		= 2;				//产品级别的规则
	public final static int TYPE_PLAN			= 3;				//投保计划级别的规则
	public final static int TYPE_PROPOSAL		= 4;				//建议书级别的规则
	public final static int TYPE_OUTSIDE		= 5;				//扩展规则
	public final static int TYPE_COMBINE		= 6;				//产品组合规则
