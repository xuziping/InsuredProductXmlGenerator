...
import com.xuzp.insuredxmltool.core.tool.data.DataHub;
...
public class Insurance implements Serializable
{
	...
	public static final int PRODUCT			= 1; //普通产品
	...
	int type							= Insurance.PRODUCT;		//对象类型，产品、组合
	 ...
	 * 基本参数
	 */
	Map	options							= new LinkedHashMap(); 			//可选的各类列表
