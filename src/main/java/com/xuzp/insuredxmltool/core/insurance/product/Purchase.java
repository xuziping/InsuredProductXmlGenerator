...
public class Purchase implements Serializable
{
	 ...
	 * 保额的类型描述
	 */
	public final static int QUANTITY 				= 1;	//按份数
	public final static int AMOUNT 					= 2;	//按保额
	public final static int RANK 					= 3;	//按档次
	public final static int PREMIUM 				= 4;	//按保费
	public final static int NONE				 	= 5;	//无需输入（inputMode专用）
	public final static int PREMIUM_AND_AMOUNT		= 6;	//需要输入保费和保额（inputMode专用）
	public final static int RANK_AND_QUANTITY 		= 7;	//按档次和份数
	public final static int PREMIUM_OR_AMOUNT		= 8;	//需要输入保费或者保额（inputMode专用）
