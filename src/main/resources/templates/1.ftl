...
<declare>
    <product
        ...
        <attachment>
            ...
            <!--<item>（1）本合同被保险人于本合同生效或最后复效之日起 90 日内（含90日当日）因疾病导致身故或全残，我们按本合同已交保险费给付身故或全残保险金，本合同终止。</item>-->
            <!--<item>（2）本合同被保险人因意外伤害事故导致身故或全残，或者于本合同生效或最后复效之日起 90 日后因疾病导致身故或全残，我们按本合同保险金额给付身故或全残保险金，本合同终止。</item>-->
            <!--</paragraph>-->
            <!---->
            <!--</coverage>-->

            <!--<product_presentation filter="coverage" parser="coverage">-->
            <!--<paragraph title="基础信息">-->
            <!--<item>用较少的钱 解决最担心的事</item>-->
            <!--<item>免体检额度最高为100万</item>-->
            <!--</paragraph>-->
            <!--<paragraph title="最低保费">-->
            <!--<item>105元</item>-->
            <!--</paragraph>-->
